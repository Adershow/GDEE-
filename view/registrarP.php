...
<body>
    <div class="card">
        ...
        <div class="card-body px-lg-5">
            ...
            <!-- Form -->
            <form class="text-center" action="../gdee/registrarP/registrarProf" style="color: #757575;" method="post" enctype="multipart/form-data">

                <p>Registre os Professores</p>
                ...
                <!-- E-mai -->
                <div class="md-form">
                    <input type="email" id="materialSubscriptionFormEmail" name="email" class="form-control" placeholder="Email">
                </div>

                

                <div class="md-form">
                    <input type="password" id="materialSubscriptionFormEmail" name="senha" class="form-control" placeholder="Senha">
                </div>

                <div class="md-form">
                    <input type="password" id="materialSubscriptionFormEmail" name="confirmarSenha" class="form-control" placeholder="Confirmar Senha">
                </div>

                <div class="custom-control custom-checkbox custom-control-inline">
                  <input type="checkbox" name="adm" class="custom-control-input" id="defaultInline1">
