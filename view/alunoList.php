...
<header class="header-area">
    ...
    <div class="crose-main-menu">
        ...
        <form class="form-inline md-form mr-auto mb-4" action="alunoList/listarAlunos" method="post">
        ...
        margin-top: 20px;">
        <?php 
        foreach($_SESSION['eventos'] as $ev){?>
            ...
            <div class="card-body">
                ...
                <form action="areaInterna/listarDados" method="post">
                    ...
                    <button type="submit" name="aluno" value="<?php echo $ev['id'];?>" class="btn btn-primary" style="margin: auto;" >Acessar</button>
                </form>
            </div>
...
<nav aria-label="pagination example">
    <ul class="pagination pagination-lg justify-content-center">
        ...
        <li class="page-item">
            ...
            ?>
            <form action="eventosList/previewNext" method="post">
        ...
        <?php while($i < $_SESSION['numero']) { $i++;?>
            <form action="eventosList/limite" method="post">
